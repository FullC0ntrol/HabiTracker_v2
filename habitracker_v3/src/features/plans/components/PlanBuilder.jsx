...
// WAŻNE: korzystamy z prawdziwego serwisu, tego samego co usePlans
...
export function PlanBuilder({
  ...
  const handleRepsInput = (day, exId, value) => {
    // Pozwól tylko na liczby i myślniki
  ...
  const savePlan = async () => {
    ...
    try {
      ...
      // tu idzie prawdziwy request do backendu
      ...
      <div className="bg-white/5 backdrop-blur-md rounded-xl border border-white/20 p-4 space-y-4 shadow-xl">
        ...
        <div className="space-y-3 pt-4 border-t border-white/10">
          <h4 className="font-medium text-white text-sm">
            Dostępne ćwiczenia (Kliknij, aby dodać)
          </h4>
...
// Przykładowe dane dla testowania komponentu poza główną aplikacją
