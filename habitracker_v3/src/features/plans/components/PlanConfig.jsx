    ...
    <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-black/30 border border-[rgb(var(--color-primary-light))]/20 rounded-lg px-3 py-2 pr-10 text-white text-sm focus:outline-none focus:ring-1 focus:ring-[rgb(var(--color-primary-light))]"
              >
                {[2, 3, 4, 5, 6].map((n) => (
              ...
              <ChevronDown className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[rgb(var(--color-primary-light))]/60" />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-2">
              {Array.from({ length: daysCount }).map((_, i) => (
                <input
                  ...
                  className="bg-black/30 border border-[rgb(var(--color-primary-light))]/20 rounded-lg px-3 py-2 text-white text-sm placeholder-white/40 focus:outline-none focus:ring-1 focus:ring-[rgb(var(--color-primary-light))]"
      ...
      <div className="flex justify-end">
        <button 
          ...
          className="bg-gradient-to-r from-[rgb(var(--rgb-primary))] to-[rgb(var(--color-secondary))] hover:from-[rgb(var(--color-primary-light))] hover:to-[rgb(var(--color-secondary))] text-white px-6 py-2.5 rounded-lg font-medium text-sm transition-all hover:scale-[1.02]"
        >
