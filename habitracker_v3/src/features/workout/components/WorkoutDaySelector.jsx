...
/**
 * WorkoutDaySelector - Premium Design
 * - Piękne karty z gradient borders
 * - Smooth animations
 * - Glassmorphism
 * - Responsive grid
 */
      ...
      <div className="relative z-10 w-full max-w-2xl px-4 py-6 sm:py-8">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3">
            <span
              className="bg-gradient-to-r from-cyan-200 via-cyan-100 to-white
        ...
        >
          {/* Background glow */}
          <div
            className="absolute inset-0 bg-gradient-to-r from-emerald-500/0 to-emerald-400/0
                       group-hover:from-emerald-500/10 group-hover:to-emerald-400/10
                       transition-all duration-500"
          />
          {/* Content */}
          ...
          {/* Arrow */}
          <ChevronRight
            className="relative z-10 w-5 h-5 text-emerald-400/60
